...
## Goal
Update `src/components/Footer.jsx` with dense columns layout, glass effect background, and updated styling.
...
### 1. Replace Footer component
Replace the entire Footer component with the dense columns layout:
...
- Commit changes with message: "feat: update Footer with dense columns layout"

## Report File
Write your report to: `D:\Rusil\test\.superpowers\sdd\task-5-report.md`
